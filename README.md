...
하지만, 기본기는 다르다. 새로운 기술을 안써본 것은 부끄럽지 않아도 된다. 오히려 입사해서 이거 같이 개발해볼래요? 하면서 분위기가 좋아질 수 있다. 하지만, 기본기가 떨어지는 것을 들키게 되면, 그 사람은 경력이 중급이어도 부끄러운 민낯을 들키는 것이지 않을까 싶다. 요즘, 인터뷰때 단순히 뭔가를 해봤어? 하는 질문류들이 굉장히 많다. 하지만, 시니어 급의 면접관 분들이 참여하신다면, 조금 이야기가 달라진다.<br>

내 경우는 전 직장 면접 시에 시니어분들이 effective java 등에서 나왔던 중요한 개념들을 유도해가며 질문을 받았던 경험이 있다. 예를 들면 전직장의 경우다. hashCode 의 개념이 무엇인지에서부터, 싱글턴은 뭔지, 어떻게 구현하는지 설명하게끔 유도하고, 스프링의 장점을 설명해보라고 하는 등의 질문을 받았었다. 물론 전직장 개발팀장님 뿐 아니라, OO 서비스의 파트장님도 함께 면접에 참여해서 다 각도의 인성면접과, 참을성(?)테스트 등을 받았던것 같다.<br>

Effective Java 의 내용을 정리하는 것이 5개월이면 될 것 같았다. 하지만, 회사일도 있고, 제대로 내용을 알고 정리하려면, 다른 공부도 병행하면서 내년 4월 까지를 목표를 잡아야 할 것 같다는 생각이 든다. 기본기는 빠르게 쌓이는 것이 아니고, 시간을 들여서 꾸준히 쌓아나가야 한다는 생각으로 정리할 예정이다.<br>
